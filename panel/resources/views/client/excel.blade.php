                    ...
                    <div class="row">
                        <div class="col-6 text-center my-3 border-right">
                            ...
                            <a href="{{env('APP_URL')}}/excel/Plantilla_Alta_Clientes.xlsx">
                                <i class="fas fa-download fa-5x border border-primary rounded-circle p-5 text-primary me-2"></i>
                            </a>
                        </div>
                        <div class="col-6 text-center my-3">
                            <h4 class="my-3">Subir plantilla</h4>
                            <label for="archivo">
                                <i class="fas fa-upload fa-5x border border-primary rounded-circle p-5 text-primary me-2"></i>
