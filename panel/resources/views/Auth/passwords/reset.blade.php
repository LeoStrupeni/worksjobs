...
<div class="wrapper fadeInDown">
    <div id="formContent">
        ...
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <input type="text" id="Email" class="fadeIn first" name="email" placeholder="Email" value="{{ $email ?? old('email') }}" autofocus required>
            <input type="password" id="password" class="fadeIn second" name="password" placeholder="Nuevo Password" required>
            <input type="password" id="password_confirmation" class="fadeIn third" name="password_confirmation" placeholder="confirmar nuevo password" required>
