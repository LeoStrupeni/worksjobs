<div class="modal fade" id="editpermission" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true" >
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content" style="border: none; border-radius: 20px;">
            ...
            <div class="modal-body d-none bg-light" id="modal-body-edit-permission-error">
            ...
            <div class="modal-body bg-light" id="modal-body-edit-permission-roller">
                <div class="text-center py-5">
                    <div class="lds-roller"><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div></div>
                </div>
            </div>
            <div class="modal-body bg-light d-none" id="modal-body-edit-permission">
            ...
            <div class="modal-footer bg-light border-0 d-none" id="modal-footer-edit-permission">
                <button type="button" class="btn btn-secondary rounded-pill px-4" data-bs-dismiss="modal">
                    <i class="fas fa-times me-2"></i>Cancelar
                </button>
                <button type="button" class="btn btn-success rounded-pill px-4" id="btn-update-permission">
