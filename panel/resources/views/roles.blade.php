                    ...
                    <div class="card-header text-white border-0" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                        <div class="row align-items-center justify-content-between">
                            ...
                            <div class="col text-end">
                                <button type="button" class="btn btn-light btn-sm rounded-pill px-3 mx-1" onclick="callregister('/roles/table',1,$('#table_limit').val(),$('#table_order').val(),'si')" title="Actualizar">
                                    <i class="fa-solid fa-arrows-rotate me-1"></i>Actualizar
                                </button>
                                @if (in_array('create',Session::get('user')['permissions']['roles']))
                                    <button type="button" class="btn btn-light btn-sm rounded-pill px-3 mx-1 create" title="Nuevo rol">
                            ...
                            <table class="table table-sm table-hover text-center sortable" id="table">
                                <thead style="position: sticky; top: 0; z-index: 10; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                                    <tr class="text-white">
                                        ...
                                        <th class="column_orden" data-name="description" style="white-space: nowrap;">Descripcion</th>
