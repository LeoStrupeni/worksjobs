    ...
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable" style="min-width: 90%;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Permisos de Rol</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body d-none" id="modal-body-show-rolpermissions-error">
            ...
            <div class="modal-body d-none" id="modal-body-show-rolpermissions-sindatos">
                <div style="display:block;" class="text-center">
                    <br>
                    <br>
                    <div class="alert alert-info m-0 justify-content-center" role="alert">
            ...
            <div class="modal-body" id="modal-body-show-rolpermissions-roller">
                <div style="display:block;" class="text-center">
                    <br>
                    <br>
            ...
            <div class="modal-body d-none" id="modal-body-show-rolpermissions">
